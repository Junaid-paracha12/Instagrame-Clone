        ...
        <div className="mx-auto w-2/4 flex  place-content-center">
          ...
          <div className="flex flex-col gap-4 mt-7 px-6 my-5 text-center">
           ...
           <span className="flex flex-col items-center"> <Image
            ...
            <p className="text-sm text-center font-semibold text-slate-400/70">OR</p>
            <div className="flex flex-col gap-3">
              ...
              <p className="max-w-64 text-center text-slate-500/90 font-semibold text-xs">By signing up, you agree to our Terms , Privacy Policy and Cookies Policy .</p>
              <button
