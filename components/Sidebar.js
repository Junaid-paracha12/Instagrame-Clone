...
export default function Sidebar() {
    ...
    const sidebarAPI = [
        ...
        { title: "Search", icon: "/search.png", gap: true },
        ...
        { title: "More", icon: "/menu.png", gap: true },
      ];
    ...
    <div className=' h-[100vh] fixed overflow-y-scroll scroll-smooth scroll-hidden border-r-2 border-black'>
        ...
        <Link href={"/"}>   <Image  src={"/insta.png"} width={100} height={20} className='w-26 h-9' /></Link>
            ...
            <div className='flex flex-col gap-6'>
                {sidebarAPI.map((v,i) =>(
                    <div key={i} className='flex items-center gap-4 rounded-md  cursor-pointer hover:bg-red-500 p-2'>
