    ...
    <div className='mt-12 w-full px-9 py-6'>
        ...
        >
          {homeAPI.stories.map((v, i) => (
            <div key={i} className=''>
           <Image src={v.img} width={200} height={200} className='w-14 h-14 rounded-full object-cover' />
          ...
          {homeAPI.post.map((v,i) =>(
            <div key={i}>
                <div className='flex items-center justify-between py-3'>
                  <span className='flex items-center gap-2'>
                    <Image src={v.personimg} width={20} height={20} className='w-7 h-7 rounded-full' />
                    <span className=''>
                  ...
                  <span>
                    <Image src={v.optionsrc} width={20} height={20} className='' />
                  </span>
                </div>
                <div>
                    <Image src={v.postimg} width={2000} alt='img' height={2000} className='w-full h-[50vh]'/>
                </div>
                <div className='flex items-center justify-between py-3'>
                    <span className='flex items-center gap-3'>
                        <Image src={v.likeicon} width={20} height={20} className='' />
                        <Image src={v.commenticon} width={20} height={20} className='' />
                ...
                <input placeholder='Add a comment...' type='text' className='w-full px-2 py-1'/> 
            </div>
